        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Receita = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UsuarioId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0a466dec-ab26-4eb4-8739-f9723007c119", null, "Usuário", "USUÁRIO" },
                    { "463e87a5-639c-4a2a-b3d3-4cd86d99d7b7", null, "Administrador", "ADMINISTRADOR" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "0f396715-dc34-4089-a4e1-646325e09849", 0, "e987c344-94a0-47ea-ad4b-763c7274268e", "admin@gcook.com", true, false, null, "ADMIN@GCOOK.COM", "ADMIN", "AQAAAAIAAYagAAAAEOG7TugLvS0aWnBYRHk5XLomdBKPC4PwWeOnitAo0/LGqBdy9Kd51gwZVN/viaFHmQ==", null, false, "276022ac-db25-44bd-927f-daadc8284312", false, "Admin" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0a466dec-ab26-4eb4-8739-f9723007c119", "0f396715-dc34-4089-a4e1-646325e09849" },
                    { "463e87a5-639c-4a2a-b3d3-4cd86d99d7b7", "0f396715-dc34-4089-a4e1-646325e09849" }
                });

            migrationBuilder.InsertData(
                table: "Usuario",
                columns: new[] { "UsuarioId", "DataNascimento", "Foto", "Nome" },
                values: new object[] { "0f396715-dc34-4089-a4e1-646325e09849", new DateTime(2006, 4, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "/img/users/avatar.png", "Gustavo Santos Buzacarini" });
